...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModuleLovePlay/Macros"
  ...
  s.source       = { :git => "https://github.com/ModuleLovePlay/Macro.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Macros/Macros/**/*.{h,m}"
